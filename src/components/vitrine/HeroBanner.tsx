...
const HeroBanner = () => {
  ...
  return <section className="relative bg-gradient-to-br from-gray-600 via-gray-700 to-gray-800 text-white overflow-hidden" style={{
    ...
    height: 300
      ...
      <div className="relative max-w-6xl mx-auto px-0 py-0">
        <div className="text-center flex flex-col items-center">
          ...
          <div className="flex justify-center mb-4">
            <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full shadow-lg overflow-hidden border border-white/30 flex items-center justify-center">
              {settings.mobile_logo && <img alt={`${settings.store_name} Logo`} className="w-full h-full object-cover" src={settings.mobile_logo} />}
            </div>
          </div>
