...
const CategoryManagement = () => {
  ...
  const [categories, setCategories] = useState<Category[]>([
    { id: 1, name: "Eletrônicos", productCount: 12, color: "#8B5CF6", image: "https://images.unsplash.com/photo-1468495244123-6c6c332eeece?w=400&h=300&fit=crop" },
    { id: 2, name: "Roupas", productCount: 25, color: "#06D6A0", image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop" },
    { id: 3, name: "Casa", productCount: 8, color: "#F59E0B", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop" },
    { id: 4, name: "Beleza", productCount: 15, color: "#EF4444", image: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=300&fit=crop" },
    { id: 5, name: "Acessórios", productCount: 7, color: "#8B5CF6", image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=400&h=300&fit=crop" },
  ]);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-4">
                {newCategoryImage && (
                  <img src={newCategoryImage} alt="Preview" className="w-16 h-16 rounded-lg object-cover border" />
                )}
