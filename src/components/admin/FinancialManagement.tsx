...
const FinancialManagement = () => {
  ...
  // Lista vazia de vendas - usuários irão registrar suas próprias vendas
  const [sales, setSales] = useState<Sale[]>([]);

  // Dados vazios para gráficos - serão preenchidos com dados reais conforme vendas forem registradas
  const monthlyData = [
    { month: 'Jan', vendas: 0, lucro: 0 },
    { month: 'Fev', vendas: 0, lucro: 0 },
    { month: 'Mar', vendas: 0, lucro: 0 },
    { month: 'Abr', vendas: 0, lucro: 0 },
    { month: 'Mai', vendas: 0, lucro: 0 },
    { month: 'Jun', vendas: 0, lucro: 0 },
  ];

  // Lista vazia - será preenchida com produtos reais
